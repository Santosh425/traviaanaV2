...
?>
<h4 class="form-section-title"><?php echo e(__('Tickets / Traveller Information:')); ?></h4>
    ...
    <?php $__currentLoopData = $passengers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $passenger): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="card">
            <div class="card-header c-pointer" id="passenger_heading_<?php echo e($i + 1); ?>">
                <h4 class="mb-0 " style="font-size: 16px" data-toggle="collapse"
                    data-target="#passenger_<?php echo e($i + 1); ?>" data-bs-toggle="collapse"
                    data-bs-target="#passenger_<?php echo e($i + 1); ?>" aria-expanded="true"
                    aria-controls="passenger_<?php echo e($i + 1); ?>">
                    
                    <?php echo e(__('Traveller #:number', ['number' => $i + 1])); ?>: <?php echo e($passenger->first_name); ?>

                    <?php echo e($passenger->last_name); ?>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <strong> <?php echo e($passenger->gender); ?></strong>
                            </div>
                        </div>
                          <div class="col-md-6">
                            <div class="form-group">
                                <label><?php echo e(__('Age Group')); ?>: </label>
                                <strong> <?php echo e($passenger->age_group); ?></strong>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
...
<?php /**PATH /Users/santoshshinde/Downloads/travinana 2025/traviaana/themes/Base/Booking/Views/frontend/detail/passengers.blade.php ENDPATH**/ ?>