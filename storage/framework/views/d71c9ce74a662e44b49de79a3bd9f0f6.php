    ...
    <?php if(count($booking->passengers)): ?>
        <li class="nav-item">
            <a class="nav-link" data-toggle="tab" data-bs-toggle="tab" href="#booking-guests-<?php echo e($booking->id); ?>">
                <?php echo e(__('Traveller Information')); ?>
...
<?php /**PATH /Users/santoshshinde/Downloads/travinana 2025/traviaana/themes/Base/Booking/Views/frontend/detail/modal.blade.php ENDPATH**/ ?>