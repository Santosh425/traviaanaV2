            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    \App\Helpers\AdminForm::select2('services[]', [
                        'configs' => [
                            'ajax'        => [
                                'url'      => route("coupon.vendor.getServices"),
                                'dataType' => 'json'
                            ],
                            'allowClear'  => true,
                            'multiple'    => true,
...
<?php /**PATH /home/u529938690/domains/traviaana.com/public_html/themes/Base/Coupon/Views/frontend/vendor/form.blade.php ENDPATH**/ ?>