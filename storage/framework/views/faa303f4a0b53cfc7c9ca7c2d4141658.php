                    ...
                    <div class="d-flex items-center h-full">
                        ...
                        <div>
                            ...
                            <div class="accordion__button">
                                <?php if($row->can_book): ?>
                                    <a data-id="<?php echo e($row->id); ?>" href=""  onclick="event.preventDefault()" class="button -dark-1 px-30 h-50 bg-blue-1 text-white btn-choose-flight"><?php echo e(__("Book Now")); ?> <div class="icon-arrow-top-right ml-15"></div></a>
                                <?php else: ?>
...
<?php /**PATH /Users/santoshshinde/Downloads/travinana 2025/traviaana/themes/GoTrip/Flight/Views/frontend/layouts/search/loop-grid.blade.php ENDPATH**/ ?>