...
<div class="panel">
    ...
    <div class="panel-body">
            <div class="row">
                ...
                <div class="form-group col-lg-4">
                    <label><?php echo e(__("PNR")); ?></label>
                    <input type="text" value="<?php echo e(old("pnr",$row->pnr)); ?>" placeholder="<?php echo e(__("PNR")); ?>" name="pnr" class="form-control">
                </div>
            </div>
    </div>
</div>
...
<?php /**PATH /Users/santoshshinde/Downloads/travinana 2025/traviaana/modules/Flight/Views/admin/flight/form.blade.php ENDPATH**/ ?>