            ...
            <div class="service-info">
                <div>
                    <?php if($image_url = $service->airline->image_url): ?>
                        ...
                        <?php else: ?>
                            <?php echo get_image_tag($service->airline->image_id, 'medium', [
                                'class' => 'img-responsive',
                                'alt' => $service->airline->name,
                            ]); ?>
                    ...
                    <div class="flex-self-start">
                        ...
                        <div class="text-lh-sm ml-1">
                            <h6 class="font-weight-bold font-size-21 text-gray-5 mb-0">
                                <?php echo e($service->departure_time->format('H:i')); ?></h6>
                            <span
                                class="font-size-14 font-weight-normal text-gray-1"><?php echo e($service->airportFrom->name); ?></span>
                        </div>
                    </div>
                    <div class="text-center d-none d-md-block d-lg-none">
                        <div class="mb-1">
                            <h6 class="font-size-14 font-weight-bold text-gray-5 mb-0">
                                <?php echo e(__(':duration hrs', ['duration' => $service->duration])); ?></h6>
                        </div>
                    </div>
                    <div class="flex-self-start">
                        <div class="mr-2">
                        ...
                        <div class="text-lh-sm ml-1">
                            <h6 class="font-weight-bold font-size-21 text-gray-5 mb-0">
                                <?php echo e($service->arrival_time->format('H:i')); ?></h6>
                            <span
                                class="font-size-14 font-weight-normal text-gray-1"><?php echo e($service->airportTo->name); ?></span>
                        </div>
                    </div>
                </div>
                ...
                <?php if(!empty($flight_seat)): ?>
                    <?php $__currentLoopData = $flight_seat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if(!empty($type['number'])): ?>
                            <li>
                                <div class="label"><?php echo e(__('Flight')); ?></div>
                                <div class="val"><?php echo e($service->title); ?></div>
                            </li>
                            <li>
                                <div class="label"><?php echo e(__('PNR')); ?></div>
                                <div class="val"><?php echo e($service->pnr); ?></div>
                            </li>
                            <li>
                                <div class="label"><?php echo e(__('From')); ?></div>
                                <div class="val"><?php echo e($service->airportFrom->name); ?></div>
                                <p><?php echo e($service->departure_time->format('H:i')); ?></p>
                            </li>
                            <li>
                                <div class="label"><?php echo e(__('To')); ?></div>
                                <div class="val"><?php echo e($service->airportTo->name); ?></div>
                                <p><?php echo e($service->arrival_time->format('H:i')); ?></p>
                            </li>
                            <li>
            ...
            <ul class="review-list">
                ...
                <?php if(!empty($flight_seat)): ?>
                    <?php $__currentLoopData = $flight_seat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if(!empty($type['number'])): ?>
                            <li>
                                <div class="label"><?php echo e($type['seat_type']['name']); ?>: <?php echo e($type['number']); ?> *
                                    <?php echo e(format_money($type['price'])); ?></div>
                                <div class="val">
...
<?php /**PATH /Users/santoshshinde/Downloads/travinana 2025/traviaana/themes/Base/Flight/Views/frontend/booking/detail.blade.php ENDPATH**/ ?>