<div class="form-checkout" id="form-checkout">
    ...
    <?php if(($booking->total_guests ?? 1) > 1): ?>
        <div class="col-12 mt-30">
            <h5><?php echo e(__('Additional Customers')); ?></h5>
    ...
    <script>
        ...
        <div class="extra-customer-section border p-20 rounded mb-20" data-index="${index}">
            <div class="d-flex justify-content-between align-items-center mb-10">
                <strong><?php echo e(__('Customer')); ?> #${index + 2}</strong>
            </div>
...
<?php /**PATH /home/rishikesh/project/traviaana/themes/GoTrip/Booking/Views/frontend/booking/checkout-form.blade.php ENDPATH**/ ?>