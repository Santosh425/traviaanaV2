<div class="form-checkout" id="form-checkout">
            ...
            <div class="col-md-6 field-country">
                <div class="form-input">
                    ...
                    <label class="lh-1 text-16 text-light-1">
                        <?php echo e(__('Gender')); ?> <span class="required">*</span>
                    </label>
                </div>
            </div>
            ...
            <div class="col-md-6 field-country">
                <div class="form-input">
                    <select name="age_group" class="form-control" required>
                        ...
                        <option value="Kid"><?php echo e(__('Kid')); ?></option>
                    </select>
                    <label class="lh-1 text-16 text-light-1">
                        <?php echo e(__('Age Group')); ?> <span class="required">*</span>
                    </label>
                </div>
            </div>
            <div class="col-md-6">
    ...
    <?php if(($booking->total_guests ?? 1) > 1): ?>
        ...
        <div class="col-auto">
            <div class="d-flex items-center">
                ...
                <div class="text-14 lh-10 text-light-1 ml-10"><?php echo e(__('I have read and accept the')); ?> <a
                        target="_blank"
                        href="https://traviaana.com/page/terms-of-service-1"><?php echo e(__('terms and conditions')); ?></a></div>
    ...
    <script>
        const customerCount = <?php echo e($booking->total_guests ?? 1); ?>;
    </script>
    ...
    <script>
        ...
        <div class="extra-customer-section border p-20 rounded mb-20" data-index="${index}">
            <div class="d-flex justify-content-between align-items-center mb-10">
                <strong><?php echo e(__('Traveller')); ?> ${index + 2}</strong>
            </div>
...
<?php /**PATH /Users/santoshshinde/Downloads/travinana 2025/traviaana/themes/GoTrip/Booking/Views/frontend/booking/checkout-form.blade.php ENDPATH**/ ?>