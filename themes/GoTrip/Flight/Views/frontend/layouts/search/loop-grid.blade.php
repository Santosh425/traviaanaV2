                    ...
                    <div class="d-flex items-center h-full">
                        ...
                        <div>
                            ...
                            <div class="accordion__button">
                                @if($row->can_book)
                                    <a data-id="{{$row->id}}" href=""  onclick="event.preventDefault()" class="button -dark-1 px-30 h-50 bg-blue-1 text-white btn-choose-flight">{{__("Book Now")}} <div class="icon-arrow-top-right ml-15"></div></a>
                                @else
